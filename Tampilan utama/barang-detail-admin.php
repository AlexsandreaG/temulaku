...
<div class="sidebar">
    ...
    <div class="menu poppins">
      <ul>
        ...
        <li><a href="barang-admin.php" class="no-decoration dua"><i class="fa fa-shopping-basket margin"></i> Jual<a></li>
        <li><a href="../profile/index-admin.php?action=<?php echo $_SESSION['username']; ?>" class="no-decoration dua"><i class="fa fa-user margin"></i> Profile</a></li>
      ...
      <div class="padding margin poppins">
        <h1><?php echo $barang['nama']; ?></h1>
          ...
          <div class="float">
            ...
            <strong><p class="harga-stok">Status </strong>: <?php echo $barang['ketersediaan']; ?></p>
