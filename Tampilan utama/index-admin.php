...
<html lang="en">
  ...
  <body>
    ...
    <div class="menu">
      <ul>
        <li><a href="index-admin.php" class="no-decoration"><i class="fa fa-home"></i> Toko</a></li>
        <li><a href="barang-admin.php" class="no-decoration"><i class="no-decoration fa fa-shopping-basket"></i> Jual<a></li>
          ...
          <li class="list-group">
            ...
            <ul class="link-container">
              <li class="link-group"><br>
                <a href="../profile/index-admin.php?action=<?php echo $_SESSION['username']; ?>" class="nama-pojok">Edit</a>
              </li>
            </ul>
          </li>
        </ul>
      ...
      <h2 id="heading">Kategori</h2>
        <div class="categories">
          ...
          <?php while($kategori = mysqli_fetch_array($queryKategori)){ ?>
            <div class="category">
              <a class="no-decoration" href="index-admin.php?kategori=<?php echo $kategori['nama']; ?>">
        ...
        <div class="product">
            ...
            <div class="addbutton">
              <button class="addtocart" >
                <a href="barang-detail-admin.php?nama=<?php echo $data['nama']; ?>" class="no-decoration poppins">Beli</a>
              </button>
            </div>
