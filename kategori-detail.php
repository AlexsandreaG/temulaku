<?php
    ...
    $queryBarang1 = mysqli_query($con, "SELECT * FROM barang where kategori_id='$id'");
    $jumlahBarang1 = mysqli_num_rows($queryBarang1);
...
<head>
    ...
    <title>TemuLaku - Kategori Detail</title>
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div class="container-fluid">
                    ...
                    <nav aria-label="breadcrumb ll">
                            <ol class="breadcrumb ll">
                                ...
                                <li class="breadcrumb-item ll" aria-current="page">
                                    <a href="kategori-detail.php" class="no-decoration">
                                        Edit Kategori
                                    </a>
                                </li>
                            </ol>
            ...
            <div class="">
                <form action="" method="post">
                    <div>
                        <h3>Edit Kategori</h3>
                        <input type="text" name="kategori" id="kategori" class="form-control input" value="<?php echo $data['nama']; ?>">
                    </div>
        ...
        <div class="table-lebar">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <?php 
                                            ...
                                            $jumlah = 1;
                                            while($data=mysqli_fetch_array($queryBarang1)){
                                        ?> 
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="barang-detail.php?action=<?php echo $data['id']; ?>" class="btn btn-info bg no-decoration">
            ...
            if(isset($_POST['deleteBtn'])){
                $queryCheck = mysqli_query($con, "SELECT * FROM barang WHERE kategori_id='$id'");
                $dataCount = mysqli_num_rows($queryCheck);

                if($dataCount>0){
                    ?>
                        <div class="alert alert-primary mt-3" role="alert">
                            Kategori tidak dapat dihapus karena sedang digunakan pada barang
                        </div>
                    <?php
                    die();
                }
