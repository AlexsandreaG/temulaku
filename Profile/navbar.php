...
@media (max-width: 768px) {
  ...
  <body>
    ...
    <div class="sidebar">
      ...
      <div class="menu">
        <ul>
          <li><a href="../Tampilan utama/index.php" class="no-decoration"><i class="fa fa-home"></i> Toko</a></li>
          <li><a href="../Tampilan utama/barang.php" class="no-decoration"><i class="no-decoration fa fa-shopping-basket"></i> Jual<a></li>
