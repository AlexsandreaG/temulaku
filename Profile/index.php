      ...
      <div class="top">
          ...
          <h1>Profil Saya</h1>
            ...
            <form action="" method="post" class="profile-form">
              ...
              <label for="name">Nama</label>
                <input type="text "id="nama" name="nama" value="<?php echo $nama; ?>" autocomplete="off" class="input-1">

              <label for="email">Email</label>
                <input type="email" id="email" name="email" value="<?php echo $email; ?>" autocomplete="off" class="input-1">

              <label for="password">Password</label>
                <input type="password" id="password" name="password" value="<?php echo $password; ?>" autocomplete="off" class="input-1">
        ...
        <?php
                ...
                <?php
                        ...
                        password='$password', alamat='$alamat', ttl='$ttl', nomor_hp='$nomor_hp' where username='$username'");
