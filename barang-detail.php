<?php
    ...
    $query = mysqli_query($con, "SELECT a.*, b.nama AS nama_kategori FROM barang a JOIN kategori b ON a.kategori_id=b.id WHERE a.id='$id'");
...
<head>
    ...
    <title>Temulaku - Barang Detail</title>
            ...
            <div id="content">
                ...
                <nav aria-label="breadcrumb" class="">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item" aria-current="page">
                        <a href="barang-detail.php" class="no-decoration">
                            Edit Barang</a>
                        </li>
                    </ol>
                </nav>
            ...
            <?php
                ...
                ?>
                            <div class="alert alert-warning mt-3" role="alert">
                                    Nama, kategori, dan lokasi ditemukan wajib diisi
                            </div>
                <?php
                    }
                    else{
                        $queryUpdate = mysqli_query($con, "UPDATE barang SET nama='$nama', kategori_id='$kategori',
                        harga='$harga', deskripsi='$deskripsi', ketersediaan='$ketersediaan' WHERE id='$id'");
                ...
                ?> 
                            <div class="alert alert-warning mt-3" role="alert">
                                    Foto wajib bertipe png atau jpg
                            </div>                   
                <?php
                            }
                            else{
